...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <dx:ASPxCallbackPanel ID="MN_Panel" runat="server" Width="100%" SettingsAdaptivity-CollapseAtWindowInnerWidth="992"
        OnCallback="MN_Panel_Callback" OnPreRender="MN_Panel_PreRender" OnBeforeGetCallbackResult="MN_Panel_BeforeGetCallbackResult" ClientInstanceName="MN_Panel" EnableCallbackAnimation="true" SettingsLoadingPanel-Text="Сохранение">
        <PanelCollection>
            <dx:PanelContent runat="server">
                <dx:ASPxFormLayout ID="PostForm" runat="server" ClientInstanceName="PostFormIN" DataSourceID="PostDS" ColCount="2" ColumnCount="2" Width="100%">
                    ...
                    <Items>
                        ...
                        <dx:LayoutGroup Width="29%" ShowCaption="False" ColumnSpan="1" RowSpan="2">
                            <Items>
                                ...
                                <dx:LayoutItem FieldName="ID" ColSpan="1" Caption="№">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxSpinEdit runat="server" Number="0" ID="ID_TB" ClientReadOnly="true" Width="100%" Enabled="false"></dx:ASPxSpinEdit>
                                        </dx:LayoutItemNestedControlContainer>
                                    </LayoutItemNestedControlCollection>
                                </dx:LayoutItem>
                                ...
                                <dx:LayoutItem FieldName="Created" ColSpan="1" Caption="Дата и время">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxDateEdit runat="server" ID="Created_DE" TimeSectionProperties-Visible="true" Width="100%"></dx:ASPxDateEdit>
                                ...
                                <dx:LayoutItem FieldName="Status" ColSpan="1" Caption="Статус">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxComboBox ID="Status_CB" runat="server" DataSourceID="StatusDS" TextField="MetaName" ValueField="ID" Width="100%"></dx:ASPxComboBox>
                                ...
                                <dx:LayoutItem FieldName="Creator" ColSpan="1" Caption="Автор">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxComboBox ID="Creator_CB" runat="server" DataSourceID="UsersDS" TextField="FIO" ValueField="id" Width="100%" Enabled="false"></dx:ASPxComboBox>
                                ...
                                <dx:LayoutItem FieldName="Slug" Caption="Slug">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxTextBox runat="server" Width="100%" ID="Slug_TB" ClientInstanceName="Slug_TB"></dx:ASPxTextBox>
                                        </dx:LayoutItemNestedControlContainer>
                                    </LayoutItemNestedControlCollection>
                                </dx:LayoutItem>
                                ...
                                <dx:LayoutItem FieldName="Category" ColSpan="1" Caption="Тип" Visible="true">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxComboBox ID="Category_CB" runat="server" DataSourceID="CategoryDS" TextField="MetaName" ValueField="ID" Width="100%" Enabled="false"></dx:ASPxComboBox>
                                ...
                                <dx:LayoutItem FieldName="SubCategory" Name="SubCategory" ColSpan="1" Caption="Категория" Visible="false">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxComboBox ID="SubCategory_CB" runat="server" DataSourceID="SubCategoryDS" TextField="MetaName" ValueField="ID" Width="100%"></dx:ASPxComboBox>
                                ...
                                <dx:LayoutItem FieldName="Region" Name="Region" ColSpan="1" Caption="Район" Visible="false">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxComboBox ID="Region_CB" runat="server" DataSourceID="RegionDS" TextField="MetaName" ValueField="ID" Width="100%"></dx:ASPxComboBox>
                        ...
                        <dx:LayoutGroup ColumnSpan="1" ColumnCount="1" ShowCaption="False" Width="70%">
                            <Items>
                                ...
                                <dx:LayoutItem Caption="Галерея" ColumnSpan="1">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            
                                            <dx:ASPxImageGallery ID="PostGallegy" runat="server" Theme="MetropolisBlue"
                        ...
                        <dx:LayoutGroup ColumnSpan="1" ColumnCount="1" ShowCaption="False" Width="70%">
                            <Items>
                                <dx:LayoutItem Caption="Похожие публикации" ColumnSpan="1">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxCardView ID="PostsLike" runat="server" DataSourceID="CardDS" AutoGenerateColumns="False" KeyFieldName="ID">
                                                ...
                                                <Columns>
                                                    ...
                                                    <dx:CardViewDateColumn FieldName="Created" VisibleIndex="0"></dx:CardViewDateColumn>
                                                    <dx:CardViewTextColumn FieldName="Creator" VisibleIndex="1"></dx:CardViewTextColumn>
                                                    <dx:CardViewTextColumn FieldName="Category" VisibleIndex="6"></dx:CardViewTextColumn>
                                                </Columns>
                                                ...
                                                <EditFormLayoutProperties>
                                                    <Items>
                                                        <dx:CardViewColumnLayoutItem ColumnName="PostID" ColSpan="1" Caption="Выберите новость" CaptionSettings-Location="Top" Width="100%"></dx:CardViewColumnLayoutItem>
                                                ...
                                                <CardLayoutProperties>
                                                    <Items>
                                                        <dx:CardViewCommandLayoutItem ColSpan="1" HorizontalAlign="Right"></dx:CardViewCommandLayoutItem>
                                                        <dx:CardViewColumnLayoutItem ColumnName="Created" ColSpan="1" Caption="Дата"></dx:CardViewColumnLayoutItem>
                                                        <dx:CardViewColumnLayoutItem ColumnName="Creator" ColSpan="1" Caption="Автор"></dx:CardViewColumnLayoutItem>
                                                        <dx:CardViewColumnLayoutItem ColumnName="PostID" ColSpan="1" Caption="Заголовок"></dx:CardViewColumnLayoutItem>
                                                        <dx:CardViewColumnLayoutItem ColumnName="Category" ColSpan="1" Caption="Категория"></dx:CardViewColumnLayoutItem>
                                                        <dx:EditModeCommandLayoutItem ColSpan="1" HorizontalAlign="Right"></dx:EditModeCommandLayoutItem>
                                                    </Items>
                                                </CardLayoutProperties>
                                            ...
                                            <asp:SqlDataSource ID="PostLikeDS" runat="server" ConnectionString='<%$ ConnectionStrings:propertyConnectionString %>'
                                                SelectCommand="SELECT p.ID, 
                                                                    ...
                                                                    WHERE st.MetaData = 12;"></asp:SqlDataSource>
                    ...
                    <SettingsAdaptivity AdaptivityMode="SingleColumnWindowLimit" SwitchToSingleColumnAtWindowInnerWidth="992"></SettingsAdaptivity>
                </dx:ASPxFormLayout>
                ...
                <asp:SqlDataSource ID="UsersDS" runat="server" ConnectionString='<%$ ConnectionStrings:propertyConnectionString %>'
                    SelectCommand=" SELECT [id], 
                               [LastName] + ' ' + LEFT([FirstName], 1) + '.' + LEFT([SecondName], 1) + '.' FIO
                        FROM [dbo].[Users]
